...
public class Controller {
	...
	public ResponseEntity<List<Student>> getStudents() throws AppException {
		...
		log.info(String.format("method : %s start in Controller.getStudents", methodName));
		...
		try {
			...
			log.error(String.format("Unknown Exception occured in Controller.getStudents : %s", e.getMessage()));
